...
MENU_UNKNOWN,
	...
	MENU_OPTIONS,
		...
		MENU_SOUND,
			...
			MENU_SOUND_OK,
		MENU_MUSIC_MODE,		// ORIGINAL / RANDOM / OFF
		MENU_ADDITIONAL_SETTINGS,	// Submenu for level selection
		MENU_LEVEL_SELECT,		// NATURAL / RANDOM / GOOD ONLY / EVIL ONLY / SELECT
		MENU_LEVEL_NUMBER,		// 1-12 (active only when MENU_LEVEL_SELECT == Level_SELECT)
		MENU_FULLSCREEN,
		MENU_KEYS_RIGHT,
		MENU_KEYS_LEFT,
		MENU_OPTIONS_OK,
